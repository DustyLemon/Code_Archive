...
Country_Data = {"England":{"Birthrate_per_person_per_day" :0.001, "percentage_of_pop_killers": 1,"Civ_Population" :20,"Killer_Population":10}}
...
simulation(Country_Data[country]["Birthrate_per_person_per_day"],Country_Data[country]["percentage_of_pop_killers"],Country_Data[country]["Civ_Population"],Country_Data[country]["Killer_Population"])
